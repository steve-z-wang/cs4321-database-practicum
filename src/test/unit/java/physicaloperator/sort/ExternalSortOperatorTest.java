...
public class ExternalSortOperatorTest {
  ...
  void testLargeDataset(int bufferPages) throws Exception {
    ...
    config.setSortMethod(PhysicalPlanConfig.SortMethod.EXTERNAL, bufferPages);
    ...
    PhysicalOperator op =
        new ExternalSortOperator(
            childOperator, orderByElements, PhysicalPlanConfig.getInstance().getSortBufferPages());
