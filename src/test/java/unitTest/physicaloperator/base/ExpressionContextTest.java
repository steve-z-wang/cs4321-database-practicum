...
class ExpressionContextTest {
  ...
  public void testSetAndGetColumnValue() {
    ...
    Integer value1 = expressionContext.getColumnValue(new Column(null, "col1"));
    assertEquals(10, value1, "Expected value for 'col1' is 10");

    Integer value2 = expressionContext.getColumnValue(new Column(null, "col2"));
    assertEquals(20, value2, "Expected value for 'col2' is 20");

    Integer value3 = expressionContext.getColumnValue(new Column(null, "col3"));
  ...
  public void testGetColumnValueNonExistentColumn() {
    ...
    Integer value = expressionContext.getColumnValue(new Column(null, "col4"));
  ...
  public void testGetColumnValueBeforeSettingTuple() {
    ...
    Integer value = expressionContext.getColumnValue(new Column(null, "col1"));
  ...
  public void testSetNewTuple() {
    ...
    assertEquals(10, expressionContext.getColumnValue(new Column(null, "col1")));
    ...
    assertEquals(
        40,
        expressionContext.getColumnValue(new Column(null, "col1")),
        "Expected value to update to 40 after setting new tuple");
    assertEquals(
        50,
        expressionContext.getColumnValue(new Column(null, "col2")),
        "Expected value to update to 50 after setting new tuple");
    assertEquals(
        60,
        expressionContext.getColumnValue(new Column(null, "col3")),
