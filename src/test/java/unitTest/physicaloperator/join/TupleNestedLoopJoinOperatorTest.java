package unitTest.physicaloperator.join;
...
class TupleNestedLoopJoinOperatorTest {
  ...
  void testGetNextTupleWithoutExpression() {
    ...
    tupleNestedLoopJoinOperator = new TupleNestedLoopJoinOperator(leftOperator, rightOperator);

    // Test getNextTuple
    Tuple result = tupleNestedLoopJoinOperator.getNextTuple();
    ...
    assertNull(tupleNestedLoopJoinOperator.getNextTuple());
  }
  ...
  void testGetNextTupleWithExpression() {
    ...
    tupleNestedLoopJoinOperator =
        new TupleNestedLoopJoinOperator(leftOperator, rightOperator, expression);
  ...
  void testReset() {
    ...
    tupleNestedLoopJoinOperator =
        new TupleNestedLoopJoinOperator(leftOperator, rightOperator, null);

    tupleNestedLoopJoinOperator.reset();
